...
class ObjectDetectionPage(tk.Frame):
    ...
    def create_object_detection_page(self):
        ...
        style.configure("Treeview.Heading", font=("Open Sans", 15, 'bold'), background="#ECD7AA", foreground="#4f4e4d")
        ...
        self.table.tag_configure("myfont", font=("Helvetica", 15, 'bold'))
        ...
        ObjectDetect_Title = tk.Label(self, text="Object   Detection", font=("Canva Sans", 30, "bold"),
                                   bg="#FFFFFF", fg="#4f4e4d")
        ObjectDetect_Title.place(x=200, y=65)
    ...
    def Display(self):
        ...
        self.ShowUserInfoLabel = tk.Label(self, text=f"User   Information",
                                         ...
                                         bg="#FFF3F3", fg="#4f4e4d")
        self.ShowUserInfoLabel.place(x=880, y=80)
    ...
    def show_frame(self, canvas):
        ...
        if self.captured_image is not None:
            if len(self.model_result) == 0:
                self.nothing_found = tk.Label(self, text="No Item Detected", font=("Canva Sans", 25, "bold"),
                    bg="#FFF3F3", fg="#DF3F3F")
    ...
    def DisplayItems(self):
        ...
        self.TotalPrice = tk.Label(self, text=f"Total: $ {self.total_price}", font=("Canva Sans", 23, "bold"),
            bg="#FFF3F3", fg="#4f4e4d")
        self.TotalPrice.place(x=750, y=600)
        self.purchase_button.place(x=890, y=670)
