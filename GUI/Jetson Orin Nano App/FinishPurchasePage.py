...
class FinishPurchasePage(tk.Frame):
    ...
    def create_finish_purchase_page(self):
        ## TITLE ##
        FinishPurchase_Title = tk.Label(self, text="Purchase   Completed", font=("Canva Sans", 30, "bold"),
            bg="#FFF3F3", fg="#545454")
        FinishPurchase_Title.place(x=460, y=285)

        continue_purchase_button = Button(self, text="Continue   Purchasing", command=self.controller.show_object_detection_page,
            padx=10, pady=8, bg="#DF3F3F", bd=0, font=("Open Sans", 13, "bold"), activebackground="#FF3A3A",
