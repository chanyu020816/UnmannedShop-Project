...
class CreateAccountPage(tk.Frame):
    ...
    def create_create_account_page(self):
        ...
        CaptureFace_Title = tk.Label(self, text="Facial  Photograph (for Recognition)", font=("Canva Sans", 16, "bold"),
            bg="#FFF3F3", fg="#4f4e4d")
        CaptureFace_Title.place(x=120, y=120)
        ...
        ## TITLE ##
        UserLogin_Title = tk.Label(self, text="Create    Account", font=("Canva Sans", 30, "bold"), bg="#FFF3F3", fg="#FF3A3A")
        UserLogin_Title.place(x=880, y=80)
        ...
        self.email_entry = tk.Entry(self, highlightthickness=0, relief='flat', bg="#F89B9B", fg="#000000",
                                    font=("yu gothic ui ", 17), insertbackground = '#6b6a69', borderwidth=7,
                                    textvariable = email)
        ...
        BacktoLogin_button = Button(self, text="Back to Login", command=self.controller.show_login_page, padx=10,
            pady=8, bg="#DF3F3F", bd=0, font=("Open Sans", 18, "bold"), activebackground="#FF3A3A",
