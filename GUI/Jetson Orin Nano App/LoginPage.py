...
class LoginPage(tk.Frame):
    ...
    def create_login_page(self):
        ## TITLE ##
        UserLogin_Title = tk.Label(self, text = "User    Login", font=("Canva Sans", 30, "bold"),
            bg="#FFF3F3", fg="#4f4e4d")
        UserLogin_Title.place(x=920, y=140)

        ## FaceRecog TITLE ##
        FaceRecog_Title = tk.Label(self, text="Facial    Login", font=("Canva Sans", 25, "bold"),
            bg="#FFFFFF", fg="#4f4e4d")
        FaceRecog_Title.place(x=235, y=170)
        ...
        self.UnDetectedLabel = tk.Label(self, text="In the process of facial recognition...",
                                        font=("yu gothic ui", 13, "bold"), bg="#FFFFFF", fg="#4f4e4d")
        self.nofaceLabel = tk.Label(self, text="No face detected.",
                                        font=("yu gothic ui", 13, "bold"), bg="#FFFFFF", fg="#4f4e4d")
        self.nofaceLabel.place(x=185, y=550)
        ...
        create_account_button = Button(self, text="Create   Account", command=self.toCreateAccountPage, padx = 10, pady = 8,
            bg = "#DF3F3F", bd = 0, font = ("Open Sans", 18, "bold"), activebackground = "#FF3A3A",
        ...
        self.resetFD_button = Button(self, text="Reset", command=self.resetFD,
            padx=10, pady=8, bg="#DF3F3F", bd=0, font=("Open Sans", 18, "bold"),
    ...
    def submit(self, username, password):
        ...
        if ps_result.total_rows == 0:
            ...
            self.user_not_found_label = tk.Label(self, text="Username or Email not found, please try again.",
                bg="#FFF3F3", fg="red", font=("Open Sans", 17))
            ...
            if len(faceCurFrame) == 0:
                ...
                for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
                    ...
                    if any(matches):
                        ...
                        # img_t = cv2.putText(img_t, image_name, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 2)
